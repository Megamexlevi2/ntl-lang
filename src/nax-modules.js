...
function parseGithubUrl(url) {
  // Accepts: github.com/user/repo or github.com/user/repo@tag
...
async function fetchJson(url) {
  // Works on Node 18+ (native fetch) and older Node (http/https)
...
/**
 * Load a nax module from GitHub.
 * Usage in NTL: val mod = nax("github.com/user/repo")
 */
async function naxLoad(url) {
  ...
  // Anti-steal protection (protect authors' modules)
